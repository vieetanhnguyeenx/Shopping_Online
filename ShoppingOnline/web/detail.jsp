...
<html lang="en">
    ...
    <body>
        ...
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row">
                <div class="col-md-6">
                    <img class="card-img-top" src="${requestScope.product.imageUrl}" alt="..." />
                </div>
                <div class="col-md-6 my-auto">
                    <div class="text-left">
                        <!-- Product name-->
                        <h1 class="fw-bolder">${requestScope.product.name}</h1>
                        <!-- Product price-->
                        <p class="fs-3 text-muted text-decoration-line-through">$5000.00</p>
                        <p class="fs-2">$${requestScope.product.price}</p>
                        <p class="fw-lighter">${requestScope.product.description}</p>
                        ...
                        <a class="btn btn-outline-dark  me-2" href="add-to-cart?productId=${requestScope.product.id}">
                            <i class="bi-cart-fill me-1"></i>
                            Add to cart
                        </a>
                ...
                <div class="row justify-content-center">
                    <div class="col-3 mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="http://dummyimage.com/250x250.png/dddddd/000000" alt="..." />
                            <!-- Product details-->
